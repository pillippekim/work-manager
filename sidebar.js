    ...
    nav.innerHTML =
        ...
        '<div class="menu-group">' +
            ...
            '<div class="cat-item" id="c-quality">' +
                ...
                '</button>' +
                '<div class="cat-body">' +
                    '<a class="nav-link" href="https://pillippekim.github.io/project-moon/inspection_round.html"><span class="n-icon">📋</span>공정검사 작성</a>' +
                    '<a class="nav-link" href="https://pillippekim.github.io/project-moon/inspection_round_viewer.html"><span class="n-icon">📂</span>공정검사 조회</a>' +
                '</div>' +
            '</div>' +
